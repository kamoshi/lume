...
fn token_to_binop(tok: &Token) -> Option<BinOp> {
    match tok {
        ...
        Token::Plus => Some(BinOp::Custom("+".to_string())),
        Token::Minus => Some(BinOp::Custom("-".to_string())),
        Token::Star => Some(BinOp::Custom("*".to_string())),
        Token::Slash => Some(BinOp::Custom("/".to_string())),
